...
public class PermissionController {
    ...
    @PostMapping("")
    public ResponseEntity<Permission> createPermission(@Valid @RequestBody PermissionDTO p) throws Exception {
        // check exist
    ...
    @PutMapping("")
    public ResponseEntity<Permission> updatePermission(@Valid @RequestBody PermissionDTO p) throws Exception {
        // check exist by id
        if (permissionService.fetchById(p.getId()) == null) {
        ...
        // update permission
        return ResponseEntity.ok().body(permissionService.update(p));
    }
